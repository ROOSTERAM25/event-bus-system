...
export class Backend implements backendInterface {
    ...
    async getDeliveryLogs(): Promise<Array<DeliveryLog>> {
    ...
    async publishEvent(arg0: string, arg1: string, arg2: string): Promise<[Event, Array<DeliveryLog>]> {
        if (this.processError) {
            try {
    ...
    async subscribe(arg0: string, arg1: string): Promise<Subscriber> {
        if (this.processError) {
            try {
    ...
    async unsubscribe(arg0: Id): Promise<boolean> {
        if (this.processError) {
            try {
