import { c as createLucideIcon, o, r as reactExports, v as vt, j as jsxRuntimeExports, U as Users } from "./index-Ct2y298u.js";
import { S as Skeleton } from "./skeleton-Ci_DO0UD.js";
import { a as useGetSubscribers, b as useSubscribe, c as useUnsubscribe, f as formatTimestamp } from "./types-Cnjh3dDj.js";
  ...
  return (
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm rounded-sm border border-border bg-card p-6 shadow-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              id: "confirm-dialog-title",
              className: "font-display text-sm font-semibold text-foreground",
              children: "Confirm Unsubscribe"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 font-mono text-xs text-muted-foreground leading-relaxed", children: [
            "Remove",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: subscriber.name }),
            " ",
            "from",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary", children: subscriber.subscribedEventType }),
            " ",
            "events?",
...
function SubRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-sm bg-secondary/20 font-mono text-xs font-semibold text-foreground", children: sub.name.slice(0, 2).toUpperCase() }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate font-mono text-sm font-semibold text-foreground", children: sub.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[10px] text-muted-foreground", children: [
            "listens to:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: sub.subscribedEventType })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden shrink-0 font-mono text-[10px] text-muted-foreground sm:block", children: formatTimestamp(sub.createdAt) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function Subscriber() {
  ...
  const [pendingUnsubscribe, setPendingUnsubscribe] = reactExports.useState(null);
  const { data: subscribers = [], isLoading } = useGetSubscribers();
  const subscribeMutation = useSubscribe();
  const unsubscribeMutation = useUnsubscribe();
  function handleSubscribe() {
    if (!name.trim() || !eventType.trim()) {
      ue.error("Please enter both a name and an event type.");
      return;
    }
    subscribeMutation.mutate(
      { name: name.trim(), eventType: eventType.trim() },
      {
        ...
        onError: (err) => ue.error(`Subscribe failed: ${err.message}`)
      }
    );
  }
  function handleConfirmedUnsubscribe() {
    ...
    unsubscribeMutation.mutate(pendingUnsubscribe.id, {
      onSuccess: () => {
        ue.success(`"${pendingUnsubscribe.name}" unsubscribed.`);
        setPendingUnsubscribe(null);
      },
      onError: (err) => {
        ue.error(`Unsubscribe failed: ${err.message}`);
        setPendingUnsubscribe(null);
      }
    });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl space-y-6", "data-ocid": "subscriber.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-sm bg-chart-2/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-5 w-5 text-chart-2" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-semibold tracking-tight text-foreground", children: "Subscribers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground", children: "Register a component to listen for a specific event type on the Event Bus." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "event-header-mono", children: "New Subscriber" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: EVENT_SUGGESTIONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: subscribeMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  LoaderCircle,
                  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "subscriber.list", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "event-header-mono", children: "Active Subscribers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-xs text-muted-foreground", children: [
          subscribers.length,
          " total"
        ] })
      ] }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "subscriber.list.loading_state", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-sm" }, i)) }) : subscribers.length === 0 ? (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "mx-auto mb-3 h-8 w-8 text-muted-foreground/40" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-sm text-muted-foreground", children: "No subscribers yet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body mt-1 text-xs text-muted-foreground", children: "Use the form above to add the first subscriber." })
            ]
          }
        )
      ) : (
        // Subscriber card rows
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: subscribers.map((sub, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          SubRow,
          {
            sub,
            index: i + 1,
    ...
    pendingUnsubscribe && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
